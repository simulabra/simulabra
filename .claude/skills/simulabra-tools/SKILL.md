...
description: A useful collection of tools to navigate Simulabra code. Always read when working on Simulabra before listing files and grepping for definitions.
allowed-tools: Bash
---
