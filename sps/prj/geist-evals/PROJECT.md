...
| 2 | plan/phase2-comprehensive-scenarios.md | Full scenario coverage, snapshot diffs, multi-turn evals | TODO |
| 3 | plan/phase3-reporting.md | Markdown reports, run comparison, metadata | TODO |
